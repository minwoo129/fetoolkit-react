...
| 이름           | 설명                                                                                                                                          | 호환여부                 | 공식문서 |
| :------------- | :-------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------- | :------: |
| ErrorBoundary  | React 기본 탑재 기능인 ErrorBoundary를 함수 컴포넌트 및 HOC 형태로 제공하는 컴포넌트                                                          | ✅ React <br> ❌ Next.js | 공식문서 |
| Flatlist       | 많은 양의 스크롤이 필요한 리스트 아이템을 보여주고자 할 때 사용할 수 있는 컴포넌트 <br> (참고: React Native 개발자라면 이해할 수 있을겁니다!) | ✅ React <br> ❌ Next.js | 공식문서 |
...
| useScroll           | 스크롤 위치를 추적하고, 스크롤을 최상단으로 이동시키는 기능을 제공하는 Hook              | ✅ React <br> ❌ Next.js | 공식문서 |
...
| useUserAgent        | UserAgent를 통해 받아온 런타임이 돌아가고 있는 브라우저 및 운영체제 정보를 반환하는 Hook | ✅ React <br> ❌ Next.js | 공식문서 |

#### 2-3. 유틸리티 함수

| 이름         | 설명                                                                                     | 호환여부                 | 공식문서 |
| :----------- | :--------------------------------------------------------------------------------------- | :----------------------- | :------: |
| getUserAgent | UserAgent를 통해 받아온 런타임이 돌아가고 있는 브라우저 및 운영체제 정보를 반환하는 Hook | ✅ React <br> ❌ Next.js | 공식문서 |
